...
contract SilverBonds is ERC3475 {
    ...
    struct Data {
        ...
        address userChainAddress;
        string[] collatorDocURL;
    }
    ...
    constructor() {
        ...
        _classes[1]._values["description"].stringValue = unicode"Collator will raise 5,000 GLMR tokens to stake as a Moonbeam collator. Once stake is reached, than collator will share rewards with bond token holders.";
        _classes[1]._values["issuerName"].stringValue = "Moon305";
        _classes[1]._values["issuerType"].stringValue = "LTD";
        _classes[1]._values["issuerJurisdiction"].stringValue = "MX";
        _classes[1]._values["issuerURL"].stringValue = "http://www.moonbonds.xyz/";
        _classes[1]._values["issuerLogo"].stringValue = "https://moonbeam.network/community/collators/";
        //rating
        _classes[1]._values["riskLevel"].stringValue = "BBB";
        _classes[1]._values["ISIN"].stringValue = "00000000";
        _classes[1]._values["fundType"].stringValue = "corporate";  
        _classes[1]._values["shareValue"].uintValue = 1;  
        _classes[1]._values["currency"].stringValue = "GLMR";  

        _classes[1]._values["maximumSupply"].uintValue = 100;  
        _classes[1]._values["callable"].boolValue = true;  
        _classes[1]._values["maturityPeriod"].uintValue = 1;  
        _classes[1]._values["coupon"].boolValue = true;  
        _classes[1]._values["couponRate"].uintValue = 1;  
        _classes[1]._values["couponPeriod"].uintValue = 1;  
        _classes[1]._values["fixed-rate"].boolValue = true;  
        _classes[1]._values["APY"].uintValue = 100000;  
        _classes[1]._values["collatorLink"].stringValue = "https://moonbeam.network/community/collators/";
